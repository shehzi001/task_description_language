...
NLU_LCM::NLU_LCM(Parser *parser,World *world,LLM *llm,DCG *dcg,const unsigned int& beamWidth,const string& worldChannel) : _lcm( new LCM()) 
{
  if( _lcm->good() ){
    _lcm->subscribe( worldChannel, &NLU_LCM::_receive_world, this );
    _lcm->subscribe( "SPEECH_RECOGNITION_OUTPUT", &NLU_LCM::_receive_speech, this );
...
void NLU_LCM::object_to_object_t( const Object& object,object_t& msg)
{
...
void NLU_LCM::object_set_to_object_set_t( const Object_Set& objectSet,object_set_t& msg )
{
...
void NLU_LCM::world_to_world_t( const World& world,world_t& msg )
{
...
void NLU_LCM::region_to_region_t( const Region& region, region_t& msg )
{
...
void NLU_LCM::constraint_to_constraint_t( const Constraint& constraint,constraint_t& msg )
{
...
void NLU_LCM::constraint_set_to_constraint_set_t( const Constraint_Set& constraintSet,constraint_set_t& msg )
{
...
void NLU_LCM::object_from_object_t( Object& object,const object_t& msg )
{
...
void NLU_LCM::object_set_from_object_set_t( Object_Set& objectSet,const object_set_t& msg )
{
...
void NLU_LCM::world_from_world_t( World& world,const world_t& msg )
{
...
void NLU_LCM::region_from_region_t( Region& region,const region_t& msg )
{
...
void NLU_LCM::constraint_from_constraint_t( Constraint& constraint,const constraint_t& msg )
{
...
void NLU_LCM::constraint_set_from_constraint_set_t( Constraint_Set& constraintSet,const constraint_set_t& msg )
{
...
void NLU_LCM::_send_constraint_set( void )
{
  if( !_lcm->good() )
  {
...
void NLU_LCM::_receive_world( const ReceiveBuffer* buf,const string& channel,const world_t * msg )
{
  if( _world != NULL ){
...
void NLU_LCM::_receive_speech( const ReceiveBuffer* buf,const string& channel,const xml_string_t * msg )
{
    cout << "Recieved message:" << msg->xml << endl;
    //_line_edit_sentence->insert (QString::fromStdString(msg->xml));
    _run_inference("go to the crate");
...
{
  ostream&
  operator<<( ostream& out,const NLU_LCM& other ) {
    return out;
  }
}
