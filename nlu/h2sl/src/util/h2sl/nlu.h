...
namespace h2sl {
  ...
  class NLU : public QWidget {
    Q_OBJECT
  public:
    NLU( Parser * parser = NULL, World * world = NULL, LLM * llm = NULL, DCG * dcg = NULL, const unsigned int& beamWidth = 4, QWidget * parent = NULL );
    virtual ~NLU();
  ...
  std::ostream& operator<<( std::ostream& out, const NLU& other );
}
